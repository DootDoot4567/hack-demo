  ...
  <div class="bg-green-100 p-4 rounded-md mb-3">
    ...
    <div class={`overflow-hidden transition-all duration-300 ${isOpen2 ? 'max-h-screen px-12 py-2' : 'max-h-0 p-0'}`}>
      <div class="text-black my-3">
        <div class="mb-1 text-lg font-medium">Marathon</div>
        <Progressbar 
          progress="10" 
          animate 
          precision={0} 
        ...
        <div class="text-black my-3">
          <div class="mb-1 text-lg font-medium">Online Web Development Course</div>
          <Progressbar 
            progress="70" 
            animate 
            precision={0} 
        ...
        <div class="text-black my-3">
          <div class="mb-1 text-lg font-medium">Internship Applications</div>
          <Progressbar 
            progress="50" 
            animate 
            precision={0} 
