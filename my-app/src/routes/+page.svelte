...
<main class="h-screen flex flex-col items-center justify-center bg-gradient-to-r from-green-400 to-green-600 text-white">
    <p class="text-xl font-semibold mb-8" tabindex="0">{subtitle}</p>
    
    <!-- Add the image with floating effect -->
    <div class="aspect-square max-w-[108px]">
        <img src="/Logo_hack@davsn.png" alt="Hack@Davidson Logo" class="w-auto h-auto animate-floating" />
    </div>
    

    <a class="pt-4" href="/about">
