...
<button class="text-gray-500 md:px-4 md:py-2 hover:text-indigo-600 text-xl font-semibold" on:click={() => $showModal = true} on:click={() => toggleModal('login')}>
    Log in
</button>
        ...
        <div class="w-[75%] max-w-sm min-w-[200px] pt-4">
            <div class=" flex flex-col space-y-4 relative">
                ...
                <div>
                    ...
                    />
                    <p class="flex items-start mt-2 text-xs text-slate-400 hidden">
